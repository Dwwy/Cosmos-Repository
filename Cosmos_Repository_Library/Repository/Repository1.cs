...
{
    public class Repository1<TItem> : IRepository<TItem> where TItem:IItem
    {
        private Container container;
        private int retry;
        public Repository1(CosmosClient client, string databaseId, string containerId, int retryAttempts)
        {
